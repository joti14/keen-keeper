...
const FriendsDetailsPage = async ({ params }) => {
    ...
    return (
        <div className='py-10'>
            <div className='grid grid-cols-5 gap-3 max-w-6xl mx-auto items-stretch'>
                ...
                <div className='col-span-3 flex flex-col gap-3'>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        <div className="card bg-base-100 shadow-sm text-center p-4 justify-center h-full">
                        ...
                        <div className="card bg-base-100 shadow-sm text-center p-4 justify-center h-full">
                            <h2 className="text-3xl font-bold text-[#244D3F]">{new Date(next_due_date).toLocaleDateString('en-us', {
