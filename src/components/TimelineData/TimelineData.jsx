...
const TimelineData = ({ entry }) => {
    return (
            <div
                className='flex items-center gap-3 sm:gap-4 p-3 sm:p-4 mb-3 bg-base-100 shadow-sm rounded-xl'>
                <div className="text-2xl sm:text-4xl text-gray-500">
                    {checkInIcons[entry.checkInType]}
                </div>

                <div className="flex flex-col">
                    <p className="font-semibold text-[#244D3F] text-base sm:text-2xl mb-1 sm:mb-2">
